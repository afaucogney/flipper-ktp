...
public class Toothpick {
  ...
  private static ToothpickOnScopeTreeChangeListener onScopeTreeChangeListener;

  public static void setOnScopeTreeChangeListener(ToothpickOnScopeTreeChangeListener listener) {
    onScopeTreeChangeListener = listener;
  }
  ...
  private static Scope openScope(Object name, boolean isRootScope) {
    synchronized (ROOT_SCOPES) {
      ...
      onScopeTreeChangeListener.onScopeChanged();
      return scope;
    }
  }
